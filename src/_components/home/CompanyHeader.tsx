          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-3 max-w-2xl leading-relaxed text-slate-500">
                This platform evaluates your organization&apos;s AI
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                ...
                {company?.country && (
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-100 px-4 py-2 text-xs font-medium text-slate-600">
